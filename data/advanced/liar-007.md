---
id: liar-007
title: Political claim about economy
...
Provenance: LIAR / PolitiFact (arXiv:1705.00648), item 1046.json. PolitiFact rating, withheld from the scenario: Mostly False. Party affiliation recorded in the source (republican) is omitted from the scenario to avoid partisan priming. References a real public figure; included from a published research dataset.
...
Attributed to: John Boehner (Speaker of the House of Representatives, Ohio)
Where it appeared: a press release.
Topic: economy,stimulus
